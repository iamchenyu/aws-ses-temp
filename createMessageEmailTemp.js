...
const htmlContent = fs.readFileSync(
  "./templates/messageReceivedTemplate.html",
  "utf8"
);
const txtContent = fs.readFileSync(
  "./templates/messageReceivedTemplate.txt",
  "utf8"
);

const params = {
  Template: {
    TemplateName: "messageReceivedTemplate",
    SubjectPart: "Notification - Message Received",
